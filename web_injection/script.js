$(document).ready(function () {
    ...
    if (getUrlParameter("auth") === "1" && getUrlParameter("token")) {
        $("#skInput").val("Getting session key from the API...");
        $("#tokenInput").val(getUrlParameter("token"));
        var params = {
        ...
        params.format = "json";
        params.api_sig = sig;
        $.get(apiInfo.baseurl, params, function (data) {
            $("#skInput").val(data.session.key);
        });
    }
